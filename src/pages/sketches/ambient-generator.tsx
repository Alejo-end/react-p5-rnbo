...
const AmbientGenerator: NextPage = () => {
    ...
    const draw: Draw = (p5) => {
        ...
        categories.forEach((category, sectionIndex) => {
            ...
            categoryParams.forEach((param, paramIndex) => {
                ...
                if (p5.mouseIsPressed || (p5.touches && p5.touches.length > 0)) {
                    const mx = p5.mouseIsPressed ? p5.mouseX : p5.movedX
                    const my = p5.mouseIsPressed ? p5.mouseY : p5.movedY
        ...
        if (activeKnob !== null) {
            const currentY = p5.mouseIsPressed ? p5.mouseY : (p5.touches && p5.touches.length > 0 ? p5.movedY : lastY)
